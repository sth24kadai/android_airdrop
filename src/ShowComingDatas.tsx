...
export default class ShowComingDatas extends Component<
    NativeStackScreenProps<RootStackParamList, "写真の保存">
> {
    ...
    getBase64URI(): string[] {
        return this.getRecentData().filter((uri) =>
